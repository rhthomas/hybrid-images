...
Hybrid images are formed by summing together two \textit{different} low-pass and high-pass filtered images. The higher frequencies dominate when the viewing distance is short, however at a longer distance the lower frequencies dominate. 

We can produce a hybrid image using the two images from the previous section, the effect of which is shown in figure~\ref{fig:visual}.
